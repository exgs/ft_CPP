...
/*
	NinjaTrap yunslee("yunslee");
	NinjaTrap jikang_temp("jikang");
	NinjaTrap ykoh("ykoh");
	NinjaTrap jikang(jikang_temp);
	cout.setf(ios::left);
	ykoh.show_status();
...
*/
	...
	//ninjaShoes
	std::cout << "=-=-=-=-=-=-=-=-=-=- ninjaShoes =-=-=-=-=-=-=-=-=-=-" << std::endl;
	yunslee.show_status();
	yunslee.ninjaShoebox(hjung);
	yunslee.show_status();
	yunslee.ninjaShoebox(jinbkim);
	yunslee.show_status();
	yunslee.ninjaShoebox(yunslee);
	yunslee.show_status();
	yunslee.ninjaShoebox(ykoh);
	yunslee.show_status();
